...
function recallme() {
    jQuery(".ult_dual_button").each(function (a) {
        ...
        if (("undefined" == c || "" == c) && (c = "on"), "on" == c) {
            ...
            if (e > 300 && 768 >= e) var h = "inset 0px -" + f + "px 0px 0px ",
                i = " inset 0px " + g + "px 0px 0px ";
            else if (e > 768 && 1015 > e) var h = "inset 0px -" + f + "px 0px 0px ",
                i = " inset 0px " + g + "px 0px 0px ";
    ...
    jQuery(a).each(function () {
        jQuery(this).bsf_appear(function () {
            if ("none" != jQuery(this).css("display")) {
                ...
                for (m = 1; a >= m; m++) {
                    var l = m * ((180 + 2 * f) / a);
                    "full" == i ? (d > l && 1 == m ? (j = d - l, k = !1) : l > d && 1 == m && (j = l - d, k = !0), 1 == k ? l -= j : l += j) : l = l + g - f + h, l = .0174532925 * l, b.push(c * Math.cos(l)), b.push(c * Math.sin(l))
                }
                var m = 0,
                    n = 0,
...
function setmytime() {
    ...
    function (a) {
        ...
        a.fn.vc_translate_row = function () {
            ...
            a(this).each(function (d, e) {
                ...
                if ("false" == h) {
                    ...
                    var k = a(e).outerHeight(),
                        ...
                        p = c - c * (j / 100),
                        q = (p - n) / p * (1 - i);
                    q > 0 && (o = 1 - q), p >= n ? (i > o ? o = i : o > 1 && (o = 1), a(e).children().each(function (b, c) {
            ...
            var b = 0,
                ...
                e = function () {
                    jQuery(".ifb-jq-height").each(function () {
                        ...
                        var a = parseInt(jQuery(this).find(".ifb-front").outerHeight(!0)),
                            b = parseInt(jQuery(this).find(".ifb-back").outerHeight(!0)),
                            c = a > b ? a : b;
                        ...
                        if (jQuery(this).hasClass("horizontal_door_flip") || jQuery(this).hasClass("vertical_door_flip")) {
                            var a = parseInt(jQuery(this).find(".ifb-front").outerHeight()),
                                b = parseInt(jQuery(this).find(".ifb-back").outerHeight()),
                                c = a > b ? a : b;
                ...
                e()
            }, 500) : e(), jQuery(window).resize(function () {
            ...
            if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && e >= 1 ? jQuery(".ult-animation").css("opacity", 1) : d(), f(), jQuery(".ubtn").hover(function () {
                    var a = jQuery(this);
                    a.find(".ubtn-text").css("color", a.data("hover")), a.find(".ubtn-hover").css("background", a.data("hover-bg"));
                    var b = a.attr("style");
                    if ("" != a.data("shadow-hover")) {
                        a.css("box-shadow");
                        b += "box-shadow:" + a.data("shadow-hover")
                    }
                    if (a.attr("style", b), "" != a.data("border-hover") && a.css("border-color", a.data("border-hover")), "none" != a.data("shadow-click")) {
                    ...
                    var a = jQuery(this);
                    a.find(".ubtn-text").removeAttr("style"), a.find(".ubtn-hover").removeAttr("style");
                ...
                }), /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) var g = !0;
            else var g = !1;
            jQuery("#page").click(function () {
                ...
                a.stopPropagation(), jQuery(this).hasClass("ifb-hover") ? jQuery(this).removeClass("ifb-hover") : (jQuery(".ifb-hover").removeClass("ifb-hover"), jQuery(this).addClass("ifb-hover"))
        ...
        function a() {
            jQuery(".ultimate-map-wrapper").each(function (a, b) {
                var c = jQuery(b).attr("id"),
                    d = jQuery(b).find(".ultimate_google_map").attr("id"),
                ...
                if ("full" == e && (g = jQuery("body"), f = "false"), "ex-full" == e && (g = jQuery("html"), f = "false"), !isNaN(e))
                    for (var a = 0; e > a && "HTML" != g.prop("tagName"); a++) g = g.parent();
    ...
    function (a) {
        ...
        recallme(), jQuery(window).resize(function () {
            recallme()
        })
    }), jQuery(document).ready(function () {
            ...
            jQuery(".ult_exp_section_layer").each(function (a, b) {
                ...
                if (0 != c) {
                    ...
                    if ("full" == c && (e = jQuery("body"), d = "false"), "ex-full" == c && (e = jQuery("html"), d = "false"), !isNaN(c))
                        for (var a = 1; c > a && "HTML" != e.prop("tagName"); a++) e = e.parent();
                ...
                if ("" != e)
                    if (e >= 768) {
                        ...
                        if (a(this).hasClass("style_9")) {
                            ...
                            if (a(this).css("height", "initial"), a(this).find(".ifb-back").find(".ifb-flip-box-section").hasClass("ifb-flip-box-section-vertical-middle")) {
                                var g = (a(this).find(".ifb-back").find(".ifb-flip-box-section").hasClass("ifb-flip-box-section-vertical-middle"), a(this).find(".ifb-back").outerHeight());
                                g = parseInt(g);
                                var h = a(this).find(".ifb-back").find(".ifb-flip-box-section").outerHeight();
                                h = parseInt(h), h >= g && a(this).find(".ifb-back").find(".ifb-flip-box-section").addClass("ifb_disable_middle")
            ...
            a(".ultimate-call-to-action").each(function (b, c) {
                ...
                if (0 != d) {
                    ...
                    if ("full" == d && (f = a("body"), e = "false"), "ex-full" == d && (f = a("html"), e = "false"), !isNaN(d))
                        for (var b = 1; d >= b && "HTML" != f.prop("tagName"); b++) f = f.parent();
                    var g = f.outerWidth(),
                        h = a(c).offset().left,
                ...
                d.options.functionBefore.call(d.$el, d.$el, function () {
                    if (d.enabled && null !== d.Content) {
                        ...
                        if ("hidden" !== d.Status) {
                            ...
                            if (BaseStyle = BaseStyle + " " + l + " " + m + " " + n + " " + k, d.$tooltip = a('<div class="ult-tooltipster-base ' + d.options.theme + '" style="' + BaseStyle + '"><div class="ult-tooltipster-content" style="' + h + '"></div></div>'), g() && d.$tooltip.addClass(i), d._content_insert(), d.$tooltip.appendTo("body"), d.reposition(), d.options.functionReady.call(d.$el, d.$el, d.$tooltip), g() ? (d.$tooltip.addClass(i + "-show"), d.options.speed > 0 && d.$tooltip.delay(d.options.speed), d.$tooltip.queue(e)) : d.$tooltip.css("display", "none").fadeIn(d.options.speed, e), d._interval_set(), a(b).on("scroll." + d.namespace + " resize." + d.namespace, function () {
                                    d.reposition()
                                }), d.options.autoClose)
            ...
            reposition: function () {
                ...
                if (0 !== a("body").find(e.$tooltip).length) {
                    ...
                    if (e.options.arrow) {
                        ...
                        if (0 !== O) {
                            var R = "",
                                S = "border-color: " + P + ";"; - 1 !== M.indexOf("bottom") ? R = "margin-top: -" + Math.round(O) + "px;" : -1 !== M.indexOf("top") ? R = "margin-bottom: -" + Math.round(O) + "px;" : -1 !== M.indexOf("left") ? R = "margin-right: -" + Math.round(O) + "px;" : -1 !== M.indexOf("right") && (R = "margin-left: -" + Math.round(O) + "px;"), Q = '<span class="ult-tooltipster-arrow-border" style="' + R + " " + S + ';"></span>'
                        }
        ...
        a(document).ready(function (c) {
            function d() {
                a('a[href="#"]').click(function (a) {
                    ...
                    c(".ult-hotspot-tooltip[data-link_style='tootip']", c(this)).each(function () {
                        if (a(this).find(".aio-icon-img").length > 0) var b = a(this).find(".aio-icon-img").outerHeight(!0),
                            d = a(this).find(".aio-icon-img").outerWidth(!0);
                        else var b = jQuery(this).find(".aio-icon").outerHeight(!0),
                        ...
                        m = c(this).find(".hotspot-tooltip-content").html(m).text(), "top" == i && (e = 0), "bottom" == i && (e = b), "left" == i && (e = -e, f = 0), "right" == i && (f = d, e = -e), /firefox/.test(navigator.userAgent.toLowerCase()) && (f = 0, e = 0), c(this).ulttooltipster({
                            content: m,
                            position: i,
                            offsetX: f,
                            offsetY: e,
            ...
            d(), a(b).load(function () {
                if (a(".ult_hotspot_container").length > 0) {
                    ...
                    "show" === b && a(".ult-hotspot-tooltip[data-link_style='tootip']").ulttooltipster("destroy"), d()
                }
    ...
    function (a, b, c) {
        ...
        jQuery.fn.reverse = [].reverse, a.SwatchBook = function (b, c) {
            ...
            _openItem: function (a) {
                var b = a.index();
                b !== this.current && (-1 !== this.options.closeIdx && b === this.options.closeIdx ? (this._openclose(), this._setCurrent()) : (this._setCurrent(a), a.css({
                    transform: "rotate(0deg)"
        ...
        a(this).find("ul.ult_tabmenu li a.ult_a").click(function (b) {
            jQuery("html,body").stop(), a(this).closest("li.ult_tab_li").siblings().each(function (b, c) {
    ...
    function (a) {
        jQuery(document).ready(function () {
            ...
            function b(a, b) {
                ...
                if ("undefined" != typeof c && "true" == c.toString()) {
                    var o = shape_css = svg = inner_html = seperator_css = shape_css = "",
                        ...
                        r = "uvc-seperator-" + q;
                    ("undefined" == typeof e || "" == e || "undefined" == e) && (e = 0), e = parseInt(e);
                    var s = e / 2,
                        t = 0;
                    if ("triangle_seperator" == d) seperator_class = "ult-trinalge-seperator";
                    else if ("circle_seperator" == d) seperator_class = "ult-circle-seperator";
                    else if ("diagonal_seperator" == d) seperator_class = "ult-double-diagonal";
                    else if ("triangle_svg_seperator" == d) seperator_class = "ult-svg-triangle", svg = '<svg class="uvc-svg-triangle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 0.156661 0.1"><polygon points="0.156661,3.93701e-006 0.156661,0.000429134 0.117665,0.05 0.0783307,0.0999961 0.0389961,0.05 -0,0.000429134 -0,3.93701e-006 0.0783307,3.93701e-006 "/></svg>', p = !0;
                    else if ("circle_svg_seperator" == d) seperator_class = "ult-svg-circle", svg = '<svg class="uvc-svg-circle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 0.2 0.1"><path d="M0.200004 0c-3.93701e-006,0.0552205 -0.0447795,0.1 -0.100004,0.1 -0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1l0.200004 0z"/></svg>', p = !0;
                    else if ("xlarge_triangle_seperator" == d) seperator_class = "ult-xlarge-triangle", svg = '<svg class="uvc-x-large-triangle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M-0 0.333331l4.66666 0 0 -3.93701e-006 -2.33333 0 -2.33333 0 0 3.93701e-006zm0 -0.333331l4.66666 0 0 0.166661 -4.66666 0 0 -0.166661zm4.66666 0.332618l0 -0.165953 -4.66666 0 0 0.165953 1.16162 -0.0826181 1.17171 -0.0833228 1.17171 0.0833228 1.16162 0.0826181z"/></svg>', p = !0;
                    else if ("xlarge_triangle_left_seperator" == d) seperator_class = "ult-xlarge-triangle-left", svg = '<svg class="uvc-x-large-triangle-left" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M4.66667 0l0 0.239949 -3.35382 0 -1.31285 -0.239949 0 0.239949 1.31285 0 3.35382 -0.239949zm-4.66667 0.239965l4.66666 0 0 0.0933661 -4.66666 0 0 -0.0933661z"/></svg>', p = !0;
                    else if ("xlarge_triangle_right_seperator" == d) seperator_class = "ult-xlarge-triangle-right", svg = '<svg class="uvc-x-large-triangle-right" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M4.66667 0l0 0.239949 -3.35382 0 -1.31285 -0.239949 0 0.239949 1.31285 0 3.35382 -0.239949zm-4.66667 0.239965l4.66666 0 0 0.0933661 -4.66666 0 0 -0.0933661z"/></svg>', p = !0;
                    else if ("xlarge_circle_seperator" == d) seperator_class = "ult-xlarge-circle", svg = '<svg class="uvc-x-large-circle" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil1" d="M4.66666 0l0 7.87402e-006 -3.93701e-006 0c0,0.0920315 -1.04489,0.166665 -2.33333,0.166665 -1.28844,0 -2.33333,-0.0746339 -2.33333,-0.166665l-3.93701e-006 0 0 -7.87402e-006 4.66666 0z"/></svg>', p = !0;
                    else if ("curve_up_seperator" == d) seperator_class = "ult-curve-up-seperator", svg = '<svg class="curve-up-inner-seperator uvc-curve-up-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M-7.87402e-006 0.0148858l0.00234646 0c0.052689,0.0154094 0.554437,0.154539 1.51807,0.166524l0.267925 0c0.0227165,-0.00026378 0.0456102,-0.000582677 0.0687992,-0.001 1.1559,-0.0208465 2.34191,-0.147224 2.79148,-0.165524l0.0180591 0 0 0.166661 -7.87402e-006 0 0 0.151783 -4.66666 0 0 -0.151783 -7.87402e-006 0 0 -0.166661z"/></svg>', p = !0;
                    else if ("curve_down_seperator" == d) seperator_class = "ult-curve-down-seperator", svg = '<svg class="curve-down-inner-seperator uvc-curve-down-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 4.66666 0.333331" preserveAspectRatio="none"><path class="fil0" d="M-7.87402e-006 0.0148858l0.00234646 0c0.052689,0.0154094 0.554437,0.154539 1.51807,0.166524l0.267925 0c0.0227165,-0.00026378 0.0456102,-0.000582677 0.0687992,-0.001 1.1559,-0.0208465 2.34191,-0.147224 2.79148,-0.165524l0.0180591 0 0 0.166661 -7.87402e-006 0 0 0.151783 -4.66666 0 0 -0.151783 -7.87402e-006 0 0 -0.166661z"/></svg>', p = !0;
                    else if ("tilt_left_seperator" == d) seperator_class = "ult-tilt-left-seperator", svg = '<svg class="uvc-tilt-left-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 4 0.266661" preserveAspectRatio="none"><polygon class="fil0" points="4,0 4,0.266661 -0,0.266661 "/></svg>', p = !0;
                    else if ("tilt_right_seperator" == d) seperator_class = "ult-tilt-right-seperator", svg = '<svg class="uvc-tilt-right-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 4 0.266661" preserveAspectRatio="none"><polygon class="fil0" points="4,0 4,0.266661 -0,0.266661 "/></svg>', p = !0;
                    else if ("waves_seperator" == d) seperator_class = "ult-wave-seperator", svg = '<svg class="wave-inner-seperator uvc-wave-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 6 0.1" preserveAspectRatio="none"><path d="M0.199945 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c-0.0541102,0 -0.0981929,-0.0430079 -0.0999409,-0.0967008l0 0.0967008 0.0999409 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm2.00004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm-0.1 0.1l-0.200008 0c-0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1 -7.87402e-006,0.0552205 -0.0447874,0.1 -0.1,0.1l0.2 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm-0.400008 0l-0.200008 0c-0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1 -7.87402e-006,0.0552205 -0.0447874,0.1 -0.1,0.1l0.2 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm-0.400008 0l-0.200008 0c-0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1 -7.87402e-006,0.0552205 -0.0447874,0.1 -0.1,0.1l0.2 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm-0.400008 0l-0.200008 0c-0.0552126,0 -0.0999921,-0.0447795 -0.1,-0.1 -7.87402e-006,0.0552205 -0.0447874,0.1 -0.1,0.1l0.2 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm-0.400008 0l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1 3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1zm1.90004 -0.1c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.200004 0c7.87402e-006,0.0552205 0.0447874,0.1 0.1,0.1l-0.2 0c0.0552126,0 0.0999921,-0.0447795 0.1,-0.1zm0.200004 0c3.93701e-006,0.0552205 0.0447795,0.1 0.100004,0.1l-0.200008 0c0.0552244,0 0.1,-0.0447795 0.100004,-0.1zm0.199945 0.00329921l0 0.0967008 -0.0999409 0c0.0541102,0 0.0981929,-0.0430079 0.0999409,-0.0967008z"/></svg>', p = !0;
                    else if ("clouds_seperator" == d) seperator_class = "ult-cloud-seperator", svg = '<svg class="cloud-inner-seperator uvc-cloud-seperator" xmlns="http://www.w3.org/2000/svg" version="1.1" fill="' + f + '" width="100%" height="' + j + '" viewBox="0 0 2.23333 0.1" preserveAspectRatio="none"><path class="fil0" d="M2.23281 0.0372047c0,0 -0.0261929,-0.000389764 -0.0423307,-0.00584252 0,0 -0.0356181,0.0278268 -0.0865354,0.0212205 0,0 -0.0347835,-0.00524803 -0.0579094,-0.0283701 0,0 -0.0334252,0.0112677 -0.0773425,-0.00116929 0,0 -0.0590787,0.0524724 -0.141472,0.000779528 0,0 -0.0288189,0.0189291 -0.0762362,0.0111535 -0.00458268,0.0141024 -0.0150945,0.040122 -0.0656811,0.0432598 -0.0505866,0.0031378 -0.076126,-0.0226614 -0.0808425,-0.0308228 -0.00806299,0.000854331 -0.0819961,0.0186969 -0.111488,-0.022815 -0.0076378,0.0114843 -0.059185,0.0252598 -0.083563,-0.000385827 -0.0295945,0.0508661 -0.111996,0.0664843 -0.153752,0.019 -0.0179843,0.00227559 -0.0571181,0.00573622 -0.0732795,-0.0152953 -0.027748,0.0419646 -0.110602,0.0366654 -0.138701,0.00688189 0,0 -0.0771732,0.0395709 -0.116598,-0.0147677 0,0 -0.0497598,0.02 -0.0773346,-0.00166929 0,0 -0.0479646,0.0302756 -0.0998937,0.00944094 0,0 -0.0252638,0.0107874 -0.0839488,0.00884646 0,0 -0.046252,0.000775591 -0.0734567,-0.0237087 0,0 -0.046252,0.0101024 -0.0769567,-0.00116929 0,0 -0.0450827,0.0314843 -0.118543,0.0108858 0,0 -0.0715118,0.0609803 -0.144579,0.00423228 0,0 -0.0385787,0.00770079 -0.0646299,0.000102362 0,0 -0.0387559,0.0432205 -0.125039,0.0206811 0,0 -0.0324409,0.0181024 -0.0621457,0.0111063l-3.93701e-005 0.0412205 2.2323 0 0 -0.0627953z"/></svg>', p = !0;
                    ...
                    } else var J = '<div class="ult-vc-seperator ' + l + " " + seperator_class + " " + r + '" data-full-width="' + k + '" data-border="' + g + '" data-border-width="' + i + '"><div class="ult-main-seperator-inner">' + inner_html + "</div>" + m + "</div>";
                    if (b.prepend(J), seperator_css = "<style>." + r + " .ult-main-seperator-inner { " + seperator_css + " }</style>", "" != n && (n = "<style>." + r + " .ult-main-seperator-inner { " + n + " }</style>", seperator_css += n), "" != m) {
                        var K = j / 2;
                    ...
                    1 == p && jQuery("." + r).find("svg").css("height", j), jQuery("head").append(seperator_css)
                }
            }
            ...
            jQuery(window).scroll(function () {
                ...
                return jQuery(this).each(function () {
                    ...
                    var N = function () {
                        var a, b, c, e = "",
                            f = "";
                        if (c = d, resize_selector = c.find(".upb_video-bg"), "full" == k && (c = jQuery("body")), "ex-full" == k && (c = jQuery("html")), !isNaN(k))
                            for (var g = 0; k > g && "HTML" != c.prop("tagName"); g++) c = c.parent();
                        b = resize_selector.parents("upb_video_class").outerHeight(), a = c.outerWidth(), "browser_size" == k && (b = jQuery(window).height(), a = jQuery(window).width(), c.css("min-height", b + "px")), resize_selector.css({
                            "min-height": b + "px",
                            "min-width": a + "px"
                        }), c.offset() && (e = c.offset().left, resize_selector.offset() && (f = resize_selector.offset().left));
                        var h, i, j = a,
                            l = b,
                        ...
                        var n = 16 / 9;
                        if (m && (l > j / n ? (h = Math.ceil(l * n), m.width(h).height(l).css({
                                left: (j - h) / 2,
                                top: 0
                            ...
                            o > j / (16 / 9) ? (embeddedvideoplayer.css("width", "auto"), embeddedvideoplayer.css("height", "100%")) : (embeddedvideoplayer.css("width", "100%"), embeddedvideoplayer.css("height", "auto"))
                        }
                    };
                    N(), "" != C && (d.addClass("ult-vc-hide-row"), d.attr("data-hide-row", C)), d.attr("data-rtl", D), d.addClass("upb_video_class"), d.attr("data-row-effect-mobile-disable", B), "fadeout_row_value" == x && (d.addClass("vc-row-fade"), d.attr("data-fadeout-percentage", y)), d.attr("data-upb_br_animation", n), e && (-1 != e.indexOf("youtube.com") ? c = "youtube" : -1 != e.indexOf("vimeo.com") && (c = "vimeo"));
                    var O = "";
                    if ("display_control" == v) {
                        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) var P = "ult-vid-cntrlplay",
                            Q = "pause";
                        else var P = "ult-vid-cntrlpause",
                            Q = "play";
                        O = '<span class="video-controls" data-action="' + Q + '" style="color:' + w + '"><i class="' + P + '"></i></span>'
                    }
                    if ("browser_size" == k && d.wrapInner('<div class="upb_video-text-wrapper"><div class="upb_video-text"></div></div>'), "parallax_content_value" == z) {
                        d.addClass("vc-row-translate"), d.attr("data-parallax-content-sense", A), d.wrapInner('<div class="vc-row-translate-wrapper"></div>');
                    ...
                    var T = "";
                    if ("true" == E.toString() && (T = "uvc-video-fixer"), "youtube" == c || "vimeo" == c ? d.prepend('<div class="upb_video-wrapper ' + T + '"><div class="upb_video-bg utube" data-rtl="' + D + '" data-bg-override="' + k + '" data-row="' + H + '" data-theme-support="' + J + '">' + K + "</div></div>") : d.prepend(' <div class="upb_video-wrapper"><div class="upb_video-bg" data-bg-override="' + k + '" data-rtl="' + D + '" data-row="' + H + '" data-theme-support="' + J + '"><video class="upb_video-src"></video>' + O + K + "</div></div>"), b(M, d), M.remove(), "youtube" == c) {
                        e = e.substring(e.indexOf("watch?v=") + 8, e.indexOf("watch?v=") + 19);
                        var U = d.find(".upb_video-bg");
                        "loop" == h && (h = !0), "muted" == g && (g = !0), U.attr("data-vdo", e), U.attr("data-loop", h), U.attr("data-poster", j), U.attr("data-muted", g), U.attr("data-start", l), U.attr("data-stop", m), u === !0 && (U.addClass("enable-on-viewport"), U.addClass("youtube-video"), a())
                    } else if ("vimeo" == c) {
                        ...
                        if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent) && "display_control" != v) "display_control" != v && ("" != j && (U.parent().css({
                            "background-image": "url(" + j + ")"
                        }), U.parent().find(".video-controls").hide()), U.remove());
                        else {
                            if (jQuery("<source/>", {
                                    type: "video/mp4",
                                    src: e
                                }).appendTo(U), "undefined" != typeof f && "" !== f) {
                                var V = "";
                                f.match(/.ogg/i) ? V = "video/ogg" : f.match(/.webm/i) && (V = "video/webm"), "" != V && jQuery("<source/>", {
                                    type: V,
                                    src: f
                                }).appendTo(U)
                            }
                            "muted" == g && U.attr({
                                ...
                                preload: "auto"
                            }), u === !0 ? (U.addClass("enable-on-viewport"), U.addClass("hosted-video"), a()) : "autoplay" == i && U.attr({
                                autoplay: i
                            })
                        }
                    }
                ...
                return jQuery(this).each(function () {
                    ...
                    ("undefined" == typeof F || "" === F) && (F = "wpb_row"), "undefined" == typeof G && (G = 0), "undefined" == typeof H && (H = "disable"), a.data("multi-color-overlay") && (D = a.data("multi-color-overlay"), E = a.data("multi-color-overlay-opacity"));
                    ...
                    if ("undefined" != typeof n && "true" === n.toString() && ("" != o && ("" != q && (q = "background-size:" + q + "px;"), "undefined" != typeof r && "" != r && (overlay_pattern_attachment_css = "background-attachment:" + r + ";"), overlay_pattern_html = '<div class="upb_bg_overlay_pattern" style="background-image:url(' + o + "); opacity:" + p + "; " + q + "; " + overlay_pattern_attachment_css + '"></div>'), "" != m && (overlay_color_html = '<div class="upb_bg_overlay" style="background-color:' + m + ';"></div>'), "" != D && (overlay_multi_color_html = '<div class="upb_bg_overlay ' + D + '" style="opacity:' + E + ';"></div>'), I = overlay_color_html + overlay_pattern_html + overlay_multi_color_html), G = parseFloat(G), 4.4 > G || "enable" == H)
                        if (a.prev().is("p") || a.prev().is("style")) var J = a.prev().prev();
                        else var J = a.prev();
                    else var J = a.prevAll("." + F + ":first");
                    if (J.css("position", "relative"), "browser_size" == j && (J.wrapInner('<div class="upb-background-text-wrapper"><div class="upb-background-text"></div></div>'), J.addClass("full-browser-size")), "parallax_content_value" == u) {
                        J.addClass("vc-row-translate"), J.attr("data-parallax-content-sense", v), J.wrapInner('<div class="vc-row-translate-wrapper"></div>');
                        var K = J.css("padding-top"),
                            L = J.css("padding-bottom");
                        J.find(".vc-row-translate-wrapper").css({
                            "padding-top": K,
                            "padding-bottom": L
                        }), J[0].style.setProperty("padding-top", "0px", "important"), J[0].style.setProperty("padding-bottom", "0px", "important")
                    }
                    "" != B && (J.addClass("ult-vc-hide-row"), J.attr("data-hide-row", B)), J.attr("data-rtl", C), J.prepend('<div class="upb_row_bg">' + I + "</div>"), a.remove(), b(a, J), a = J, a.attr("data-row-effect-mobile-disable", z), a.attr("data-img-parallax-mobile-disable", A), "fadeout_row_value" == s && (a.addClass("vc-row-fade"), a.attr("data-fadeout-percentage", t)), a.css("background-image", ""), a = a.find(".upb_row_bg"), a.attr("data-upb_br_animation", l), "automatic" != g ? a.css({
                        "background-size": g
                    ...
                    }), a.attr("data-parallax_sense", i), a.attr("data-bg-override", j), a.attr("data-bg-animation", w), a.attr("data-bg-animation-type", x), a.attr("data-animation-repeat", y), a.addClass(d);
                    var M = function () {
                        var b, c, d, e, f;
                        if (d = a.parent(), "full" == j && (d = jQuery("body"), e = 0), "ex-full" == j && (d = jQuery("html"), e = 0), !isNaN(j)) {
                            for (var g = 0; j > g && "HTML" != d.prop("tagName"); g++) d = d.parent();
                            e = d.offset().left
                        }
                ...
                return jQuery(this).each(function () {
                    ...
                    if (("undefined" == typeof u || "" === u) && (u = "wpb_row"), "undefined" == typeof v && (v = 0), "undefined" == typeof w && (w = "disable"), a.data("multi-color-overlay") && (s = a.data("multi-color-overlay"), t = a.data("multi-color-overlay-opacity")), v = parseFloat(v), 4.4 > v || "enable" == w)
                    ...
                    if ("undefined" != typeof e && "true" === e.toString() && ("" != g && ("" != i && (i = "background-size:" + i + "px;"), "undefined" != typeof j && "" != j && (overlay_pattern_attachment_css = "background-attachment:" + j + ";"), overlay_pattern_html = '<div class="upb_bg_overlay_pattern" style="background-image:url(' + g + "); opacity:" + h + "; " + i + "; " + overlay_pattern_attachment_css + '"></div>'), "" != f && (overlay_color_html = '<div class="upb_bg_overlay" style="background-color:' + f + ';"></div>'), "" != s && (overlay_multi_color_html = '<div class="upb_bg_overlay ' + s + '" style="opacity:' + t + ';"></div>'), y = overlay_color_html + overlay_pattern_html + overlay_multi_color_html), "browser_size" == d && (x.wrapInner('<div class="upb-background-text-wrapper"><div class="upb-background-text"></div></div>'), x.addClass("full-browser-size")), "parallax_content_value" == n) {
                        x.addClass("vc-row-translate"), x.attr("data-parallax-content-sense", o), x.wrapInner('<div class="vc-row-translate-wrapper"></div>');
                    ...
                    "" != q && (x.addClass("ult-vc-hide-row"), x.attr("data-hide-row", q)), x.attr("data-rtl", r), x.prepend('<div class="upb_row_bg">' + y + "</div>"), b(a, x), a = x, a.attr("data-row-effect-mobile-disable", p), "fadeout_row_value" == l && (a.addClass("vc-row-fade"), a.attr("data-fadeout-percentage", m)), a.css("background-image", ""), a = a.find(".upb_row_bg"), a.attr("data-upb_br_animation", k), c = c.replace("url(data:image/svg+xml;base64,", "");
                    var B = c.indexOf(";");
                    c = c.substring(B + 1), a.attr("style", c), a.attr("data-bg-override", d), "browser_size" == d && a.parent().find(".upb-background-text-wrapper").addClass("full-browser-size");
                    var C = function () {
                        var b, c, e, f, g;
                        if (e = a.parent(), "full" == d && (e = jQuery("body"), f = 0), "ex-full" == d && (e = jQuery("html"), f = 0), !isNaN(d)) {
                            for (var h = 0; d > h && "HTML" != e.prop("tagName"); h++) e = e.parent();
                            f = e.offset().left
                        }
                        if (wh = jQuery(window).height(), c = a.parent().outerHeight(), b = e.outerWidth(), a.css({
                                "min-width": b + "px"
                ...
                return jQuery(this).each(function () {
                    ...
                    if (("undefined" == typeof v || "" === v) && (v = "wpb_row"), "undefined" == typeof t && (t = 0), "undefined" == typeof u && (u = "disable"), a.data("multi-color-overlay") && (r = a.data("multi-color-overlay"), s = a.data("multi-color-overlay-opacity")), t = parseFloat(t), 4.4 > t || "enable" == u)
                        if (a.prev().is("p") || a.prev().is("style")) var w = a.prev().prev();
                        else var w = a.prev();
                    ...
                    if ("undefined" != typeof j && "true" === j.toString() && ("" != l && ("" != n && (n = "background-size:" + n + "px;"), "undefined" != typeof o && "" != o && (overlay_pattern_attachment_css = "background-attachment:" + o + ";"), overlay_pattern_html = '<div class="upb_bg_overlay_pattern" style="background-image:url(' + l + "); opacity:" + m + "; " + n + "; " + overlay_pattern_attachment_css + '"></div>'), "" != k && (overlay_color_html = '<div class="upb_bg_overlay" style="background-color:' + k + ';"></div>'), "" != r && (overlay_multi_color_html = '<div class="upb_bg_overlay ' + r + '" style="opacity:' + s + ';"></div>'), x = overlay_color_html + overlay_pattern_html + overlay_multi_color_html), "browser_size" == c) w.wrapInner('<div class="upb-background-text-wrapper"><div class="upb-background-text"></div></div>');
                    else;
                    if ("" != p && (w.addClass("ult-vc-hide-row"), w.attr("data-hide-row", p)), w.attr("data-rtl", q), "parallax_content_value" == g) {
                        w.addClass("vc-row-translate"), w.wrapInner('<div class="vc-row-translate-wrapper"></div>'), w.attr("data-parallax-content-sense", h);
                        var y = w.css("padding-top"),
                            z = w.css("padding-bottom");
                        w.find(".vc-row-translate-wrapper").css({
                            "padding-top": y,
                            "padding-bottom": z
                        }), w[0].style.setProperty("padding-top", "0px", "important"), w[0].style.setProperty("padding-bottom", "0px", "important")
                    }
                    w.prepend('<div class="upb_row_bg">' + x + "</div>"), b(a, w), a.remove(), a = w, a.attr("data-row-effect-mobile-disable", i), "fadeout_row_value" == e && (a.addClass("vc-row-fade"), a.attr("data-fadeout-percentage", f)), a.css("background-image", ""), a = a.find(".upb_row_bg"), a.css({
                        background: d
                    ...
                    var A = function () {
                        ...
                        if (e = a.parent(), "full" == c && (e = jQuery("body"), f = 0), "ex-full" == c && (e = jQuery("html"), f = 0), !isNaN(c)) {
                            for (var h = 0; c > h && "HTML" != e.prop("tagName"); h++) e = e.parent();
                            f = e.offset().left
                        }
            ...
            jQuery(".upb_content_video, .upb_content_iframe").prev().is("p") ? jQuery(".upb_content_video, .upb_content_iframe").prev().prev().css("background-image", "").css("background-repeat", "") : jQuery(".upb_content_video, .upb_content_iframe").prev().css("background-image", "").css("background-repeat", ""), jQuery(".upb_content_video").ultimate_video_bg(), jQuery(".upb_bg_img").ultimate_bg_shift(), jQuery(".upb_content_iframe").ultimate_video_bg(), jQuery(".upb_grad").ultimate_grad_shift(), jQuery(".upb_color").ultimate_bg_color_shift(), jQuery(".upb_no_bg").each(function (a, b) {
                ...
                if (("undefined" == typeof h || "" === h) && (h = "wpb_row"), "undefined" == typeof i && (i = 0), "undefined" == typeof j && (j = "disable"), i = parseFloat(i), 4.4 > i || "enable" == j)
            ...
            var f = function () {
                jQuery(".upb_row_bg").each(function () {
                    ...
                    if (b = "undefined" != typeof d && "enable" !== d ? jQuery(this).parents("." + e + ":first") : jQuery(this).parent(), "browser_size" == c && (a = jQuery("html")), "ex-full" == c) a = jQuery("html");
                    ...
                    var c, d, f = jQuery(this).data("bg-override"),
                        g = jQuery(this).attr("data-rtl"),
                        h = jQuery(this).data("theme-support"),
                        i = jQuery(this).data("row");
                    if (d = "undefined" != typeof h && "enable" !== h ? jQuery(this).parents("." + i + ":first") : jQuery(this).parent(), "browser_size" == f) c = jQuery("html"), jQuery(this).parents(".upb_video_class").css("overflow", "visible");
                    else if ("ex-full" == f) c = jQuery("html"), jQuery(this).parents(".upb_video_class").css("overflow", "visible");
                    else if ("full" == f) c = jQuery("body"), jQuery(this).parents(".upb_video_class").css("overflow", "visible");
                    ...
                    var k = (parseInt(c.css("paddingLeft")), parseInt(c.css("paddingRight")), parseInt(c.css("marginLeft")), c.outerWidth()),
                        ...
                        o = c.offset().left,
                        p = o - m;
                    0 > n && (p = n + p), 0 == a && (e = n), e > 0 && (p = e), "undefined" == typeof g || g !== !0 && "true" !== g ? jQuery(this).css({
                        width: k,
                        "min-width": k,
                        left: p
                    }) : jQuery(this).css({
                    ...
                    if (/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent))("undefined" == typeof u || "none" == u) && (children.css({
                        ...
                        d.addClass("video-browser-size"), d.css("min-height", v + "px"), d.find(".upb_video-text-wrapper").length > 0 && (d.find(".upb_video-text-wrapper").addClass("full-browser-size"), d.find(".upb_video-text-wrapper").css("min-height", v + "px"))
                    }
                })
            };
            ...
            }), c(), d(), jQuery(".vcpb-animated").each(function (a, b) {
        ...
        a(document).ready(function () {
            ...
            a(".ult-video-banner").each(function (c, d) {
                ...
                a(d).find("video").get(0).addEventListener("canplay", function () {
                    return g >= 1 ? !1 : (a(d).find("video").get(0).currentTime = f, a(d).find("video").get(0).pause(), void g++)
                });
        ...
        a.fn.vTicker = function (b) {
            ...
            return moveUp = function (b, c, d) {
                if (!d.isPaused) {
                    ...
                    }), "fade" == d.animation && (e.children("li:first").fadeOut(d.speed), 0 == d.height && e.children("li:eq(" + d.showItems + ")").hide().fadeIn(d.speed)), f.appendTo(e)
                }
                ...
                if (!d.isPaused) {
                    ...
                    }), "fade" == d.animation && (0 == d.height && e.children("li:eq(" + d.showItems + ")").fadeOut(d.speed), e.children("li:first").hide().fadeIn(d.speed))
                }
            }, this.each(function () {
                var c = a(this),
                    d = 0;
