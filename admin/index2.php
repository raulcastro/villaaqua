...
<table width="800" border="0" align="center" cellpadding="10" cellspacing="0" bgcolor="#FFFFFF">
    ...
    <tr>
      <td valign="bottom" background="images/head.jpg" bgcolor="#301B1F"><table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td height="99">&nbsp;</td>
          <td><div align="right">
            <table width="100" border="0" cellpadding="4" cellspacing="1">
              <tr>
                <td><a href="login.php" class="textonormal">Log out</a></td>
              </tr>
            </table>
          </div></td>
        </tr>
...
<table width="100%" border="0" cellpadding="6" cellspacing="1" bgcolor="#999999">
        ...
        <tr>
          <td width="278" valign="top" bgcolor="#FFFFFF">
          <?php if (! is_numeric($_REQUEST["id"])){?>
          <form id="form1" name="form1" method="post" onSubmit = "return validar(this)" action="index.php"><table border="0" cellpadding="3" cellspacing="0" bgcolor="#FFFFFF">
            <tbody>
              <tr>
              ...
              <tr>
                <td class="leftMargin_10"><span >Reserved By:</span> <br />
                  Agency/Direct </td>
                <td><div id="ownerdiv"></div> <input  id="agencia" name="agencia" />
                <input name="owner" type="hidden" id="owner" value="1"/></td>
              </tr>
              <tr>
                <td class="leftMargin_10">Client Name:</td>
                <td><input  id="client" name="client" /></td>
              </tr>
              <tr>
                ...
                <td><input  id="email" name="email" /></td>
                   ...
                   <tr>
                  <td class="leftMargin_10">Reservation  Date:</td>
                  <td><div id="datediv"><?php echo $dateres;?></div></td>
                </tr>
                <tr>
                  <td class="leftMargin_10">Arrival :</td>
                  <td><input name="arrival" type="text" class="cuerpo" id="arrival" title="YYYY-MM-DD" onClick="displayCalendar(this);" size="12"></td>
                </tr>
                <tr>
                  <td class="leftMargin_10">Departure 
                    :</td>
                  <td><input name="departure"  id="departure" size="12" readonly="readonly" /></td>
                </tr>
                <tr>
...
?>
            ...
            <tbody>
              ...
              <tr>
                <td class="leftMargin_10"><span >Reserved By:</span> <br />
                  Agency/Direct </td>
                <td><div id="ownerdiv"></div> <input  id="agencia" name="agencia" value="<?php echo $row["agencia"];?>" />
                <input name="owner" type="hidden" id="owner" value="1"/></td>
              </tr>
              <tr>
                <td class="leftMargin_10">Client Name:</td>
                <td><input  id="client" name="client" value="<?php echo $row["client"];?>" /></td>
              </tr>
              <tr>
                <td class="leftMargin_10">Contact Email:</td>
                <td><input  id="email" name="email" value="<?php echo $row["emailcontact"];?>" /></td>
                </tr>
                   <tr>
                  <td class="leftMargin_10">Reservation  Date:</td>
                ...
                <tr>
                  <td class="leftMargin_10">Arrival :</td>
                  <td><input name="arrival" type="text"  id="arrival" size="12"  value="<?php echo $vllegada;?>"></td>
                </tr>
                <tr>
                  <td class="leftMargin_10">Departure 
                    :</td>
                  <td><input name="departure"  id="departure" size="12" value="<?php echo $vsalida;?>"  /></td>
                </tr>
                <tr>
                  <td class="leftMargin_10">Status:</td>
                  <td><select name="estatus" id="estatus">
                    <option value=""></option>
                      <option value="1" <?php  if($row["dateres"]==1){?>selected="selected"<?php }?>>Pending</option>
                      <option value="2" <?php  if($row["dateres"]==2){?>selected="selected"<?php }?>>Confirmed</option>
                      <option value="3" <?php  if($row["dateres"]==3){?>selected="selected"<?php }?>>Cancel</option>
                  </select></td>
                </tr>
              </tbody>
            </table>
            <input type="submit" class="botones" name="boton" id="submitbtn" style="display:block" value="Update" /><input name="editres" class="botones" type="hidden" id="editres" value="<?php echo $row["idres"];?>" /></form>
             <?php }}?>
            </td>
          <td width="488" valign="top" bgcolor="#FFFFFF"><div style="padding:5px;"><table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#CCCCCC">
            <tr>
              <td bgcolor="#003366">&nbsp;</td>
              <td bgcolor="#003366"><div align="center" class="style11">Client</div></td>
              <td bgcolor="#003366"><div align="center" class="style11">From</div></td>
              <td bgcolor="#003366"><div align="center" class="style11">To</div></td>
              <td bgcolor="#003366"><div align="center" class="style11">Status</div></td>
              <td bgcolor="#003366"><div align="center" class="style11">Agency</div></td>
              </tr>
...
$result = mysql_query($query);
	while($row = mysql_fetch_array($result)){
		...
		?>
            <tr>
              <td valign="top" bgcolor="#FFFFFF"><div align="center"><a href="index2.php?id=<?php echo $row["idres"];?>"><img src="images/icon_edit.png" width="16" height="16" border="0" /></a></div></td>
              <td valign="top" bgcolor="#FFFFFF"><div align="left"><?php echo $row["client"];?></div></td>
              ...
              <td valign="top" bgcolor="#FFFFFF"><?php echo $row["agencia"]?></td>
              </tr>
            <?php }
?>
          </table>
  ...
  <tr>
    <td><table border="0" align="center" cellpadding="7" cellspacing="0" bgcolor="#FFFFFF">
<?php 
$contarows=0;
$contacolumns=0;
$contajoin=0;
while ($contarows<3){ // formo la tabla, aqui los renglones ?>
  <tr>
...
$query="select * from availability where estatus>0 and villa=".$villaid. " and arrival <= '" . $fechin . "' and departure >='" . $fechin ."'";
$result = mysql_query($query);
	while($row = mysql_fetch_array($result))
	  {
	  $idreserva=$row['idres'];
...
if (a==2) {
if ($row['estatus']==0) {
if ($ibgro=="nb.gif" and date("d",strtotime($fechin))==date("d",strtotime($row['arrival']))) { $ibgro="2b.gif"; }
if ($ibgro=="2n.gif" and date("d",strtotime($fechin))==date("d",strtotime($row['departure']))) { $ibgro="2b.gif"; }
if ($ibgro=="n1.gif" and date("d",strtotime($fechin))==date("d",strtotime($row['departure']))) { $ibgro="2a.gif"; }
if ($ibgro="1n.gif" and date("d",strtotime($fechin))==date("d",strtotime($row['departure']))) { $ibgro="1b.gif"; }
}
if ($row['estatus']==1) {
