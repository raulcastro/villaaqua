...
$pictures = $model->getGalleryBySection('Testimonials');
?>
	<!DOCTYPE html>
	<html class='no-js' lang='en'>
		<head>
			<title>Villa Aqua Rental - Main Slider</title>
                                ...
                                <div class="wpb_wrapper">
                                    <div class="wpb_text_column wpb_content_element ">
                                        ...
                                        <div class="wpb_column vc_column_container ">
                                            <input type="hidden" id="sectionPage" value="Testimonials">
                                            <div class="mediaSections" >
												<h1>Testimonials</h1>
												<span>(618 * 800 px)</span>
